...
从 git history、GitHub releases 和 release docs 还原的发展路径。完整 first-parent commit log 在 [[Git First-Parent History]]。

## Milestones

### 2026-04-27 to 2026-05-02 - 基础阶段

初始 Unreal project、MCP scaffold/apply/rollback/build/test pipeline、supervisor、project memory、skills、Workbench UI。

### 2026-05-04 to 2026-05-07 - 模块拆分与 Registry

薄 module lifecycle、category files、dispatcher、protocol、handler registry、execution guards、verifiers、RAG/workflow tools。

### 2026-05-10 to 2026-05-12 - 本地知识与 Bridge 时代

Agent handoff 文档、RAG closed loop、multi-provider AI、Codex Desktop bridge、跨平台 bridge transport、UE 5.6 下限兼容(单一 shim header + pre-commit hook)。

### 2026-05-12 to 2026-05-14 - Export gate 与首批 pilot 包

首批 tags: export gating + path resolver + chat panel buttons(v0.11.0-export-gate, 2026-05-12)、双引擎兼容 pass 2(v0.11.3)、bridge MCP discovery 修复(v0.11.4)、scaffold graduations(v0.11.5)、首个 Mac UE 5.6 + 5.7 source-only pilot 包(v0.12.0-pilot-mac-ue56-ue57, 2026-05-13)、跨平台 Mac + Win UE 5.7 pilot(v0.12.1-pilot-crossplatform, 2026-05-14)。

### v0.14 to v0.19 - Python track 与 Task Atlas

Python runtime smoke、install verification、Task Atlas foundation、skills/RAG promotion、Make Tool、label backfill。

### v0.20 to v0.27 - 验证与安全改革

automation/diagnostics/PIE smoke、UEAtelier 品牌重命名(v0.22.2)、cli-anything-ueatelier Python CLI(v0.23.0)、provider presets、Codex rewrite、approval gate、Python user-tool track、core C++ wall-off。

### v0.28 to v0.32 - 创作工具 / Code Tools / Composites
